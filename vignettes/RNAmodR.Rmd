...
files <-  list("one" = c(Treated = system.file("extdata","example1.bam" ,package = "RNAmodR.Data")),
               "two" = c(Treated = system.file("extdata","example2.bam" ,package = "RNAmodR.Data")),
               "three" = c(Treated = system.file("extdata","example3.bam" ,package = "RNAmodR.Data")))
```
