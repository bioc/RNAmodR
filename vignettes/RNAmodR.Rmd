...
transcripts or chunks of the transcript

```{r plot3, fig.cap="Scores and data along a transcript containing a A to G conversion indicating the presence of Inosine"}
visualizeData(msi, "2", from = 25L, to = 45L)
```
