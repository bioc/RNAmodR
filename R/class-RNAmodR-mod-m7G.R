...
RNAMODR_M7G_SIGMA_THRESHOLD <- 15
...
.do_M7G_pretest <- function(location,
  ...
  if(length(testData[testData >= RNAMODR_M7G_SPM]) < n) return(NULL)
...
setMethod(
  ...
  definition = function(object,
    ...
    if(!.validate_M7G_pos(RNAMODR_M7G_SIGMA_THRESHOLD, 
